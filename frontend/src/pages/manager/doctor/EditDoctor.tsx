...
const EditDoctor = () => {
  ...
  const { data: doctor, isPending: isLoading } = useFetchDoctor(Number(id));
  ...
  useEffect(() => {
    if (doctor) {
      ...
      setValue("gender", doctor.gender as "Male" | "Female");
      setValue("yoe", doctor.yoe);
      setValue("hospital_id", doctor.hospital_id);
      setValue("specialist_id", doctor.specialist_id);
      if (doctor.photo) {
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="group/errorState flex flex-col gap-2 invalid">
                ...
                >
                  ...
                  >
                    <option value={doctor?.hospital.id}>
              ...
              <div className="group/errorState flex flex-col gap-2 invalid">
                ...
                >
                  ...
                  <select
                    ...
                    className="appearance-none w-full h-[72px] font-semibold text-lg outline-none pl-20 pr-6 pb-[14.5px] pt-[32px]"
                  >
                    <option value={doctor?.specialist.id}>
